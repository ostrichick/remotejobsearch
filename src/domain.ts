...
export type Profile = { skills:string[]; languages:string[]; experience:string[]; education:string[]; keywords:string[]; mode:'local'|'ai'; updatedAt?:string };
...
export type SearchResult = {jobs:Job[];sources:SourceResult[];searchedAt:string;keywords:string[]};
