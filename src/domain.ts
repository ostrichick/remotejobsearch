...
export type Profile = { skills:string[]; languages:string[]; experience:string[]; education:string[]; keywords:string[]; mode:'local'|'ai'; updatedAt?:string; preferences?:import('./preferences').Preferences };
